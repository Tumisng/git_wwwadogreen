...
<!--            <img class="img-responsive" src="<?php echo $strPageImg; ?>" width="100%" alt "<?php echo $strPageTitle; ?>">-->
            ...
            <div class="hidden-xs">
                <p>
                    Zimbabwe’s neighbouring countries are South Africa, Malawi, <a href="<?php echo ENV_ROOTURL; ?>africa/zambia/zambia-mining-jobs-engineering-construction-recruitment.php">Zambia</a>, <a href="<?php echo ENV_ROOTURL; ?>africa/botswana/mining-jobs-botswana-construction-engineering.php">Botswana</a>, and <a href="<?php echo ENV_ROOTURL; ?>africa/mozambique/mozambique-mining-jobs-engineering-construction-recruitment.php">Mozambique</a>. Like Zambia and Botswana, Zimbabwe is completely land locked. Zimbabwe has roughly around 16 million citizens and has 16 different official languages.
                </p>
                <br />
                <p>
                ...
                <p>
                    New business contract or critical staffing, HR or RPO needs in Zimbabwe. We specialise in the recruitment of Zimbabwean candidates (local citizens) whether it is for full time, part time or contract work in Zimbabwe. Our database consist of all levels of candidates from office commercial to project managers and CEOs – all Zimbabwean citizens. We’ve spent years developing valuable relationships and building up our database to assist you with fast precise human resource service.
                </p>
                <br>
            </div>
            <div class="hidden-xs">
    ...
    <a class="button button-green btn-block" href="<?php echo ENV_ROOTURL; ?>jobs-africa/job-board.php" role="button">
        ...
        On 15 Nov 2017 after much unrest and Zimbabwe’s declining economy, Mugabe was placed under house arrest in a coup d'état.  On 19 Nov 2017 Robert Mugabe was relieved of his presidency and the former Vice President Emmerson Mnangagwa was name president. On 21 Nov 2017, Robert Mugabe tendered in his resignation prior to being impeached.
            ...
            <div>
                ...
                <br />
                <p>Zimbabwe has a much larger population than its neighbour Botswana. Because of various reasons many of the skilled labour moved to neighbouring countries and abroad and therefore are in high demand on the skilled local workforce. As a client you want to work with an agency who understands the Recruitment, HR and RPO sectors in Zimbabwe at every level being able to provide insight into your expansion and needs. In Botswana often putting a add in the newspaper does not mean you will get the candidates. We have an extensive referral network and have built up a highly reputable name in the local Botswana Industry. Whether you are looking for market and salary information or up to running a recruitment drive for a large scale projects we have the expertise and tools to assist you.
                </p>
                <br/>
            </div>
        </div>
