...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="well">
                <h4>Heavy Industry Construction</h4>
                <p>
                    Constrcution in the heavy industry sector in Africa is mostly in countries where there are mining activities
                </p>
        ...
        <div class="col-md-6">
            ...
            <div class="well">
              <h2>Specialist Construction Recruitment In Africa</h2>
